...
Proof.
  ...
  - intros. destruct H. apply or_distributes_over_and_2. split.
    + apply H.
    + apply H0.
Qed.
*)
...
Theorem false_beq_nat : forall n m : nat,
     ...
     beq_nat n m = false.
Proof. 
  intros. unfold not in H. generalize dependent m.
  induction n.
  - intros. destruct m.
  ...
  - intros. destruct m.
    + simpl. reflexivity.
    + simpl. apply IHn. intros. apply H. rewrite H0. reflexivity.
Qed.
(** [] *)
